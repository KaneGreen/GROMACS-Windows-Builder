...
[GROMACS version](https://manual.gromacs.org/current/download.html): 2026.0

## Overall
- Target OS: Microsoft Windows 10 or 11 (64-bit).
- Target CPU: x84_64 CPUs that support AVX2 instructions.
- Bundled with [FFTW (3.3.10)](https://fftw.org), [OpenBLAS (0.3.31)](https://www.openblas.net/) and [hwloc (2.13.0)](https://github.com/open-mpi/hwloc).
...
Nvidia Windows driver (version 591.44 or higher) which supports Nvidia CUDA 13.0.2 or higher is required. **It is strongly recommended to install the latest supported GPU driver.**
