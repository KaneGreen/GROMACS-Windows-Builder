...
[GROMACS version](https://manual.gromacs.org/current/download.html): 2026.3

## Overall
- Target OS: Microsoft Windows 10 or 11 (64-bit).
- Target CPU: x84_64 CPUs that support AVX2 instructions.
- Bundled with [FFTW (3.3.11)](https://fftw.org), [OpenBLAS (0.3.33)](https://www.openblas.net/) and [hwloc (2.13.0)](https://github.com/open-mpi/hwloc).
